...
N = 100 #Cantidad de datos que aparecen al mismo tiempo en la gráfica
...
ax.set_ylim(0, 1) # fija los límites verticales del eje Y entre 0 y 1
...
def update(frame):                               # Función que actualiza los datos en cada fotograma/intervalo
    new_value = np.random.uniform(0, 1)         # Genera un nuevo valor aleatorio uniforme entre 0 y 1
